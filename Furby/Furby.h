...
#define ANTENNA_LEFT 1
#define ANTENNA_RIGHT 2
#define ANTENNA_FRONT 3
#define ANTENNA_BACK 4
...
private:
	...
	SwitchDecode inputSwitches[4] = {
		{ 1, 0x02, false, ANTENNA_LEFT },
		{ 1, 0x01, false, ANTENNA_RIGHT },
		{ 2, 0x40, false, ANTENNA_FRONT },
		{ 2, 0x80, false, ANTENNA_BACK }
	};
	...
	void getInputs(unsigned char* buffer, unsigned int length);
